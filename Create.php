...
<form action="process_input.php" class="form-container-create" method = "post" style="margin-top: 100px;">
...
<!-- genre section of form !-->
    ...
    <label for="genre" style="color: white;"><b>Favorite Genres?</b>
		...
		<select class="js-genre-basic-multiple" name="genres[]" multiple="multiple" style:"color: black, width: 100%">
